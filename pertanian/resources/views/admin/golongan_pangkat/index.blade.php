...
<div class="card" id="employeeTable">
    <div class="card-body">
        <div class="flex items-center gap-3 mb-4">
            <h6 class="text-15 grow">Golongan Pangkat(<b class="total-Employs">#</b>)</h6>
            <div class="shrink-0">
