        ...
        <form action="{{ route('jabatanBidang.update', $jabatanBidang -> idJabatanBidang)}}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-4">
                <div class="mb-3">
                    ...
                    <select class="form-input w-full" name="jabatan" id="jabatan">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-input w-full" name="bidang" id="bidang">
                ...
                <div class="mb-3 md:col-span-2">
                    ...
                    <input type="text" id="namaJabatanBidang" name="namaJabatanBidang" value="{{ old('namaJabatanBidang', $jabatanBidang->namaJabatanBidang) }}" class="form-input w-full">
                </div>
                <div class="mb-3  md:col-span-2">
